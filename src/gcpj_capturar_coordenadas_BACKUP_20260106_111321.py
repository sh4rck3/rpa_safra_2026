...
╚══════════════════════════════════════════════════════════════════════╝
    ...
    if not coordenadas:
        ...
        print("   3. Verifique se a extensão está visível")
        print("="*70)
        print("\n⚠️  A extensão ficará instalada para as próximas execuções!")
        input("\n✅ Pressione ENTER quando estiver pronto...")
    else:
        # Se já tem coordenadas, aguarda 3 segundos e continua
    ...
    try:
        ...
        dados_json = {
            ...
            "envolvidos": [],
            "advogados": [],
            "html_completo": page_source  # Guardando HTML completo para referência
        }
